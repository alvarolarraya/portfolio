...
export default function HandWrittenName() {
    return (
        <motion.div>
            <motion.svg className="handWritten" version="1.0" xmlns="http://www.w3.org/2000/motion.svg" width="95vw" viewBox="0 0 764 186" stroke="black" fill="rgb(var(--accent))">
                <motion.path 
                    variants={draw}
                    initial="hidden"
                    animate="visible"
            ...
            <motion.svg className="handWritten" version="1.0" xmlns="http://www.w3.org/2000/svg" width="100%" height="20vh" viewBox="0 0 138 108" stroke="black" fill="rgb(var(--accent))">
                <motion.path
                    variants={draw}
                    initial="hidden"
                    animate="visible" 
