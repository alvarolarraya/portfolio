...
<div>
  <p> ⦿ The bird can <b>move</b> freely througout the whole screen using ←↑↓→ keys</p><br><br>

  <p> ⦿ Pressing or holding the space key you can <b>shoot</b> the syringes. The shooting action has cooldown time.</p>
</div>
