...
function HandWrittenName() {
  return /* @__PURE__ */ React.createElement(motion.div, null, /* @__PURE__ */ React.createElement(motion.svg, { className: "handWritten", version: "1.0", xmlns: "http://www.w3.org/2000/motion.svg", width: "95vw", viewBox: "0 0 764 186", stroke: "black", fill: "rgb(var(--accent))" }, /* @__PURE__ */ React.createElement(
    motion.path,
    {
      variants: draw,
      initial: "hidden",
  ...
  )), /* @__PURE__ */ React.createElement(motion.svg, { className: "handWritten", version: "1.0", xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "20vh", viewBox: "0 0 138 108", stroke: "black", fill: "rgb(var(--accent))" }, /* @__PURE__ */ React.createElement(
    motion.path,
    {
      variants: draw,
      initial: "hidden",
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "about Alvaro Larraya", "data-astro-cid-kh7btl4r": true }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Navbar", $$Navbar, { "github": "https://github.com/alvarolarraya", ";": true, "linkedin": "https://linkedin.com/in/\xE1lvaro-larraya-830700240", ";": true, "email": "https://mail.google.com/mail/?view=cm&fs=1&to=alvaro.larraya1@gmail.com", ";": true, "data-astro-cid-kh7btl4r": true })}${maybeRenderHead()}<main data-astro-cid-kh7btl4r><div id="mainDiv" data-astro-cid-kh7btl4r><video id="pcVideo" autoplay loop muted plays-inline class="back-video" data-astro-cid-kh7btl4r><source src="/videos/parachute.mp4" type="video/mp4" data-astro-cid-kh7btl4r></video><video id="mobileVideo" autoplay loop muted plays-inline class="back-video" data-astro-cid-kh7btl4r><source src="/videos/parachute_mobile.mp4" type="video/mp4" data-astro-cid-kh7btl4r></video><div id="handWritten" data-astro-cid-kh7btl4r>${renderComponent($$result2, "HandWrittenName", HandWrittenName, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/alvar/Desktop/portfolio/src/components/HandWrittenName.jsx", "client:component-export": "default", "data-astro-cid-kh7btl4r": true })}</div>${renderComponent($$result2, "ScrollArrow", null, { "down": "#presentation", "up": "#mainDiv", "client:only": "react", "client:component-hydration": "only", "data-astro-cid-kh7btl4r": true, "client:component-path": "/Users/alvar/Desktop/portfolio/src/components/ScrollArrow.jsx", "client:component-export": "default" })}</div><div id="presentation" data-astro-cid-kh7btl4r><img id="myPhoto" src="/imgs/meBig.webp" alt="Mi foto" data-astro-cid-kh7btl4r><p data-astro-cid-kh7btl4r>Aiming to be a <b data-astro-cid-kh7btl4r>Data Scientist</b> in <b data-astro-cid-kh7btl4r>Madrid</b>. I'm very excited about both the city and the job. 
				Challenges like these constitute a great environment to develop new soft and technical skills, so I'll seize the opportunity to make it a reality. See you soon. 😄</p></div></main>` })}<link href="https://fonts.googleapis.com/css?family=Caveat" rel="stylesheet">`;
}, "/Users/alvar/Desktop/portfolio/src/pages/about.astro", void 0);

const $$file = "/Users/alvar/Desktop/portfolio/src/pages/about.astro";
const $$url = "/about";
